...
def test_links_reject_empty_or_nonexistent_builds(tmp_path: Path) -> None:
    assert links.check(tmp_path)
    assert links.check(tmp_path / 'missing')
